...
interface SparePartSaleHistoryAttributes {
    id: number;
...
class SparePartSaleHistory extends Model<SparePartSaleHistoryAttributes> implements SparePartSaleHistoryAttributes {
    public id!: number;
...
export default (sequelize: Sequelize) => {
    SparePartSaleHistory.init(
        {
            id: { type: DataTypes.INTEGER.UNSIGNED, autoIncrement: true, primaryKey: true },
            spare_part_sale_id: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false },
        ...
        { sequelize, tableName: "spare_part_sale_histories", timestamps: false }
    );
    return SparePartSaleHistory;
};